          ...
          <div id="video-carousel" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner" role="listbox">
              <div className="carousel-item active">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/1m4SZ1GNv8k?si=lRDWtLXB51jIDGMz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                </div>
              </div>
              <div className="carousel-item">
                <div className="inner-content vid-inner-content">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/gSwQwyqYXuU?si=wKID2i-_fyj4C5pY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                </div>
              </div>
              {/* Add more iframe elements for other videos */}
            </div>
