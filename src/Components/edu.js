      ...
      <div className="center-container">
        ...
        <div className="flip-container">
          <div className="flip flip-vertical">
            <div className="front" style={{ backgroundColor: "#006AA7" }}>
              <h1 className="text-shadow">Programming in C#, III</h1>
            </div>
            <div className="back" style={{ backgroundColor: "#006AA7" }}>
          ...
          <div className="flip flip-vertical">
            <div className="front" style={{ backgroundColor: "#FECC02" }}>
              <h1 className="text-shadow">Computer Networks I</h1>
            </div>
            <div className="back" style={{ backgroundColor: "#FECC02" }}>
